...
/* Arabic -- DeepL, 2026-09-15. On staging for review by a native speaker and
 ...
 "ar": {
   ...
   "phero.about.eye": "نبذة عن DRP BuildLab",
   ...
   "phero.pricing.eye": "الأسعار والباقات",
   ...
   "nav.menu": "القائمة",
   "hero.eye": "مواقع إلكترونية مصممة خصيصًا للشركات المحلية",
   "hero.l1": "نحن نتولى",
   "hero.l2": "حضورك",
   "hero.l3": "<span class=\"h-accent\">على الإنترنت.</span>",
   "hero.sub": "ليس لديك موقع إلكتروني؟ إذن فأنت غير موجود على الإنترنت. تقوم DRP BuildLab بإنشاء <strong>مواقع</strong> <strong>إلكترونية مخصصة بالكامل</strong> لرواد الأعمال المحليين — ويستند السعر إلى حجم العمل الذي يتطلبه مشروعك. نتميز دائمًا بالصدق والشفافية.",
